...
namespace WPAppStudio.Services
{
    ...
    public class NavigationService : ServicesInterfaces.INavigationService
    {
        ...
        {
            { typeof(IViewModels.IDogbreedsLetterA_ListViewModel), "/View/DogbreedsLetterA_List.xaml" },
            { typeof(IViewModels.IDogbreedsLetterE_DetailViewModel), "/View/DogbreedsLetterE_Detail.xaml" },
            { typeof(IViewModels.IDogbreedsLetterD_DetailViewModel), "/View/DogbreedsLetterD_Detail.xaml" },
            { typeof(IViewModels.IDogbreedsLetterC_DetailViewModel), "/View/DogbreedsLetterC_Detail.xaml" },
            { typeof(IViewModels.IDogbreedsLetterB_DetailViewModel), "/View/DogbreedsLetterB_Detail.xaml" },
            { typeof(IViewModels.IDogbreedsLetterA_DetailViewModel), "/View/DogbreedsLetterA_Detail.xaml" },
