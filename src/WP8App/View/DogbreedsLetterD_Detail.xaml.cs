...
{
    /// <summary>
    /// Phone application page for DogbreedsLetterD_Detail.
    /// </summary>
    [CompilerGenerated]
    [GeneratedCode("Radarc", "4.0")]
    public partial class DogbreedsLetterD_Detail : PhoneApplicationPage
    {       
        /// <summary>
        /// Initializes the phone application page for DogbreedsLetterD_Detail and all its components.
        /// </summary>
        public DogbreedsLetterD_Detail()
        {
            InitializeComponent();        
			if (Resources.Contains("PanoramaDogbreedsLetterD_Detail0AppBar"))
				PhonePage.SetApplicationBar(this, Resources["PanoramaDogbreedsLetterD_Detail0AppBar"] as BindableApplicationBar);                            
		}
		
        private void panoramaDogbreedsLetterD_Detail_SelectionChanged(object sender, SelectionChangedEventArgs e)
        {		
			InitializeAppBarpanoramaDogbreedsLetterD_Detail(PanoramaDogbreedsLetterD_Detail.SelectedItem as PanoramaItem);
        }
		
		private void InitializeAppBarpanoramaDogbreedsLetterD_Detail(PanoramaItem panoramaItem)        
        {
        ...
        protected override  void OnNavigatedTo(NavigationEventArgs e)
        {
            ...
            {
				var dataSource = new Ioc.Container().Resolve<Repositories.IDogbreedsLetterD_DogbreedsLetterD>();
				AddHomeAppBarButton();
				...
				((IViewModels.IDogbreedsLetterD_DetailViewModel)DataContext).CurrentDogbreedsLetterDSchema = pinnedItem;				
			}
		}
