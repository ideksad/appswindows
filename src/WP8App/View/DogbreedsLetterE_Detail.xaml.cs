...
{
    /// <summary>
    /// Phone application page for DogbreedsLetterE_Detail.
    /// </summary>
    [CompilerGenerated]
    [GeneratedCode("Radarc", "4.0")]
    public partial class DogbreedsLetterE_Detail : PhoneApplicationPage
    {       
        /// <summary>
        /// Initializes the phone application page for DogbreedsLetterE_Detail and all its components.
        /// </summary>
        public DogbreedsLetterE_Detail()
        {
            InitializeComponent();        
			if (Resources.Contains("PanoramaDogbreedsLetterE_Detail0AppBar"))
				PhonePage.SetApplicationBar(this, Resources["PanoramaDogbreedsLetterE_Detail0AppBar"] as BindableApplicationBar);                            
		}
		
        private void panoramaDogbreedsLetterE_Detail_SelectionChanged(object sender, SelectionChangedEventArgs e)
        {		
			InitializeAppBarpanoramaDogbreedsLetterE_Detail(PanoramaDogbreedsLetterE_Detail.SelectedItem as PanoramaItem);
        }
		
		private void InitializeAppBarpanoramaDogbreedsLetterE_Detail(PanoramaItem panoramaItem)        
        {
        ...
        protected override  void OnNavigatedTo(NavigationEventArgs e)
        {
            ...
            {
				var dataSource = new Ioc.Container().Resolve<Repositories.IDogbreedsLetterE_DogbreedsLetterE>();
				AddHomeAppBarButton();
				...
				((IViewModels.IDogbreedsLetterE_DetailViewModel)DataContext).CurrentDogbreedsLetterESchema = pinnedItem;				
			}
		}
