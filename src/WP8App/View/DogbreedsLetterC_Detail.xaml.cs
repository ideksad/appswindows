...
{
    /// <summary>
    /// Phone application page for DogbreedsLetterC_Detail.
    /// </summary>
    [CompilerGenerated]
    [GeneratedCode("Radarc", "4.0")]
    public partial class DogbreedsLetterC_Detail : PhoneApplicationPage
    {       
        /// <summary>
        /// Initializes the phone application page for DogbreedsLetterC_Detail and all its components.
        /// </summary>
        public DogbreedsLetterC_Detail()
        {
            InitializeComponent();        
			if (Resources.Contains("PanoramaDogbreedsLetterC_Detail0AppBar"))
				PhonePage.SetApplicationBar(this, Resources["PanoramaDogbreedsLetterC_Detail0AppBar"] as BindableApplicationBar);                            
		}
		
        private void panoramaDogbreedsLetterC_Detail_SelectionChanged(object sender, SelectionChangedEventArgs e)
        {		
			InitializeAppBarpanoramaDogbreedsLetterC_Detail(PanoramaDogbreedsLetterC_Detail.SelectedItem as PanoramaItem);
        }
		
		private void InitializeAppBarpanoramaDogbreedsLetterC_Detail(PanoramaItem panoramaItem)        
        {
        ...
        protected override  void OnNavigatedTo(NavigationEventArgs e)
        {
            ...
            {
				var dataSource = new Ioc.Container().Resolve<Repositories.IDogbreedsLetterC_DogbreedsLetterC>();
				AddHomeAppBarButton();
				...
				((IViewModels.IDogbreedsLetterC_DetailViewModel)DataContext).CurrentDogbreedsLetterCSchema = pinnedItem;				
			}
		}
