...
{
    /// <summary>
    /// Phone application page for DogbreedsLetterB_Detail.
    /// </summary>
    [CompilerGenerated]
    [GeneratedCode("Radarc", "4.0")]
    public partial class DogbreedsLetterB_Detail : PhoneApplicationPage
    {       
        /// <summary>
        /// Initializes the phone application page for DogbreedsLetterB_Detail and all its components.
        /// </summary>
        public DogbreedsLetterB_Detail()
        {
            InitializeComponent();        
			if (Resources.Contains("PanoramaDogbreedsLetterB_Detail0AppBar"))
				PhonePage.SetApplicationBar(this, Resources["PanoramaDogbreedsLetterB_Detail0AppBar"] as BindableApplicationBar);                            
		}
		
        private void panoramaDogbreedsLetterB_Detail_SelectionChanged(object sender, SelectionChangedEventArgs e)
        {		
			InitializeAppBarpanoramaDogbreedsLetterB_Detail(PanoramaDogbreedsLetterB_Detail.SelectedItem as PanoramaItem);
        }
		
		private void InitializeAppBarpanoramaDogbreedsLetterB_Detail(PanoramaItem panoramaItem)        
        {
        ...
        protected override  void OnNavigatedTo(NavigationEventArgs e)
        {
            ...
            {
				var dataSource = new Ioc.Container().Resolve<Repositories.IDogbreedsLetterB_DogbreedsLetterB>();
				AddHomeAppBarButton();
				...
				((IViewModels.IDogbreedsLetterB_DetailViewModel)DataContext).CurrentDogbreedsLetterBSchema = pinnedItem;				
			}
		}
