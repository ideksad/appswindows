...
{
    /// <summary>
    /// Fake DogbreedsLetterBSchema data source.
    /// </summary>
    [CompilerGenerated]
    [GeneratedCode("Radarc", "4.0")]
    public class FakeDogbreedsLetterB_DogbreedsLetterB : IDogbreedsLetterB_DogbreedsLetterB 
    {
        ...
        public ObservableCollection<Entities.DogbreedsLetterBSchema> GetData(int pageNumber = 0)
	
        {			
            var data = new ObservableCollection<Entities.DogbreedsLetterBSchema> 
			{ 
			...
			return new ObservableCollection<Entities.DogbreedsLetterBSchema>(data.Skip(MaxResults * pageNumber).Take(MaxResults));
        ...
        public ObservableCollection<Entities.DogbreedsLetterBSchema> Refresh(int pageNumber = 0)
		...
		/// <summary>
        /// Retrieves the data from a fake, filtered by a filter specification, in an observable collection of DogbreedsLetterBSchema items.
        /// </summary>
        ...
        {			
			return RepositoriesBase.Filter<Entities.DogbreedsLetterBSchema>.FilterCollection(filter, GetData());
        }
