...
{
    /// <summary>
    /// Fake DogbreedsLetterDSchema data source.
    /// </summary>
    [CompilerGenerated]
    [GeneratedCode("Radarc", "4.0")]
    public class FakeDogbreedsLetterD_DogbreedsLetterD : IDogbreedsLetterD_DogbreedsLetterD 
    {
        ...
        public ObservableCollection<Entities.DogbreedsLetterDSchema> GetData(int pageNumber = 0)
	
        {			
            var data = new ObservableCollection<Entities.DogbreedsLetterDSchema> 
			{ 
			...
			return new ObservableCollection<Entities.DogbreedsLetterDSchema>(data.Skip(MaxResults * pageNumber).Take(MaxResults));
        ...
        public ObservableCollection<Entities.DogbreedsLetterDSchema> Refresh(int pageNumber = 0)
		...
		/// <summary>
        /// Retrieves the data from a fake, filtered by a filter specification, in an observable collection of DogbreedsLetterDSchema items.
        /// </summary>
        ...
        {			
			return RepositoriesBase.Filter<Entities.DogbreedsLetterDSchema>.FilterCollection(filter, GetData());
        }
