...
{
    /// <summary>
    /// Fake DogbreedsLetterCSchema data source.
    /// </summary>
    [CompilerGenerated]
    [GeneratedCode("Radarc", "4.0")]
    public class FakeDogbreedsLetterC_DogbreedsLetterC : IDogbreedsLetterC_DogbreedsLetterC 
    {
        ...
        public ObservableCollection<Entities.DogbreedsLetterCSchema> GetData(int pageNumber = 0)
	
        {			
            var data = new ObservableCollection<Entities.DogbreedsLetterCSchema> 
			{ 
			...
			return new ObservableCollection<Entities.DogbreedsLetterCSchema>(data.Skip(MaxResults * pageNumber).Take(MaxResults));
        ...
        public ObservableCollection<Entities.DogbreedsLetterCSchema> Refresh(int pageNumber = 0)
		...
		/// <summary>
        /// Retrieves the data from a fake, filtered by a filter specification, in an observable collection of DogbreedsLetterCSchema items.
        /// </summary>
        ...
        {			
			return RepositoriesBase.Filter<Entities.DogbreedsLetterCSchema>.FilterCollection(filter, GetData());
        }
