...
{
    /// <summary>
    /// Fake DogbreedsLetterESchema data source.
    /// </summary>
    [CompilerGenerated]
    [GeneratedCode("Radarc", "4.0")]
    public class FakeDogbreedsLetterE_DogbreedsLetterE : IDogbreedsLetterE_DogbreedsLetterE 
    {
        ...
        public ObservableCollection<Entities.DogbreedsLetterESchema> GetData(int pageNumber = 0)
	
        {			
            var data = new ObservableCollection<Entities.DogbreedsLetterESchema> 
			{ 
			...
			return new ObservableCollection<Entities.DogbreedsLetterESchema>(data.Skip(MaxResults * pageNumber).Take(MaxResults));
        ...
        public ObservableCollection<Entities.DogbreedsLetterESchema> Refresh(int pageNumber = 0)
		...
		/// <summary>
        /// Retrieves the data from a fake, filtered by a filter specification, in an observable collection of DogbreedsLetterESchema items.
        /// </summary>
        ...
        {			
			return RepositoriesBase.Filter<Entities.DogbreedsLetterESchema>.FilterCollection(filter, GetData());
        }
