...
namespace WPAppStudio.BackgroundProcess
{
    public class BackgroundAgent : ScheduledTaskAgent
    {
        ...
        protected  void UpdateCycleTileData()
        {
            var agent = new CycleTileAgent();
			var newImagesFiles = new List<string>();
            var dogbreedsLetterA_DogbreedsLetterA = backgroundContainer.Resolve<IDogbreedsLetterA_DogbreedsLetterA>();
			var dogbreedsLetterA_DogbreedsLetterAItems = new List<DogbreedsLetterASchema>();
			var dogbreedsLetterA_DogbreedsLetterAData =  dogbreedsLetterA_DogbreedsLetterA.GetData();
			dogbreedsLetterA_DogbreedsLetterAItems.AddRange(dogbreedsLetterA_DogbreedsLetterAData);
            newImagesFiles.AddRange(dogbreedsLetterA_DogbreedsLetterAItems.Select(i => i.Image).ToList());
